            ...
            <div class="row align-items-center gx-0">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea name="message" v-model="message" @focus="" @keypress="startTyping()" class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true"></textarea>
